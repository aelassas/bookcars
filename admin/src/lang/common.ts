...
const strings = new LocalizedStrings({
  fr: {
    ...
    BOOKING_STATUS_PARTIAL: 'Partiel',
    BOOKING_STATUS_UNPAID: 'Impayée',
    FROM: 'Début',
    TO: 'Fin',
  ...
  en: {
    ...
    BOOKING_STATUS_PARTIAL: 'Partial',
    BOOKING_STATUS_UNPAID: 'Unpaid',
    FROM: 'From',
    TO: 'To',
  ...
  es: {
    ...
    BOOKING_STATUS_PARTIAL: 'Parcial',
    BOOKING_STATUS_UNPAID: 'No pagado',
    FROM: 'Desde',
    TO: 'Hasta',
