...
2. [Software Architecture](https://github.com/aelassas/bookcars/wiki/Architecture)
   ...
   6. [Mobile App](https://github.com/aelassas/bookcars/wiki/Architecture#mobile-app)
   7. [Shared Packages](https://github.com/aelassas/bookcars/wiki/Architecture#shared-packages)
...
3. [Advanced Features](https://github.com/aelassas/bookcars/wiki/Advanced-Features)
   1. [Security Practices](https://github.com/aelassas/bookcars/wiki/Advanced-Features#security-practices)
   2. [Monitoring & Logging](https://github.com/aelassas/bookcars/wiki/Advanced-Features#monitoring--logging)
   3. [Deployment & Hosting](https://github.com/aelassas/bookcars/wiki/Advanced-Features#deployment--hosting)
   4. [Extensibility & Customization](https://github.com/aelassas/bookcars/wiki/Advanced-Features#extensibility--customization)
   4. [Analytics & Tracking](https://github.com/aelassas/bookcars/wiki/Advanced-Features#analytics--tracking)
