...
export const es = {
  ...
  DEPOSIT_LESS_THAN_VALUE_1: `Menos de ${env.isUS ? env.CURRENCY : ''}${env.DEPOSIT_FILTER_VALUE_1}${!env.isUS ? (' ' + env.CURRENCY) : ''}`,
  DEPOSIT_LESS_THAN_VALUE_2: `Menos de ${env.isUS ? env.CURRENCY : ''}${env.DEPOSIT_FILTER_VALUE_2}${!env.isUS ? (' ' + env.CURRENCY) : ''}`,
  DEPOSIT_LESS_THAN_VALUE_3: `Menos de ${env.isUS ? env.CURRENCY : ''}${env.DEPOSIT_FILTER_VALUE_3}${!env.isUS ? (' ' + env.CURRENCY) : ''}`,
