 ...
 * @type {string}
 */
export const STRIPE_COUNTRY_CODE: string = BC_STRIPE_COUNTRY_CODE.toUpperCase()
 ...
 * @type {string}
 */
export const STRIPE_CURRENCY_CODE: string = BC_STRIPE_CURRENCY_CODE.toUpperCase()
