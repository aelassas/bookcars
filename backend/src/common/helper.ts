...
export const getDressType = (type: string) => {
  switch (type) {
    ...
    case bookcarsTypes.DressType.Designer:
      return strings.DESIGNER
    case bookcarsTypes.DressType.Wedding:
      return strings.WEDDING
    case bookcarsTypes.DressType.Evening:
      return strings.EVENING
    case bookcarsTypes.DressType.Cocktail:
      return strings.COCKTAIL
    case bookcarsTypes.DressType.Prom:
      return strings.PROM
    default:
...
export const getDressTypeShort = (type: string) => {
  switch (type) {
    ...
    case bookcarsTypes.DressType.Designer:
      return strings.DESIGNER_SHORT
    case bookcarsTypes.DressType.Wedding:
      return strings.WEDDING_SHORT
    case bookcarsTypes.DressType.Evening:
      return strings.EVENING_SHORT
    case bookcarsTypes.DressType.Cocktail:
      return strings.COCKTAIL_SHORT
    case bookcarsTypes.DressType.Prom:
      return strings.PROM_SHORT
    default:
      return strings.OTHER_SHORT
  }
}
...
export const getDressSize = (size: string) => {
  switch (size) {
    ...
    case bookcarsTypes.DressSize.DoubleExtraLarge:
      return strings.SIZE_XXL
    case bookcarsTypes.DressSize.ExtraSmall:
      return strings.SIZE_XS
    case bookcarsTypes.DressSize.Custom:
      return strings.SIZE_CUSTOM
    default:
      return ''
  }
}
...
export const getDressTypeTooltip = (type: string) => {
  switch (type) {
    ...
    case bookcarsTypes.DressType.Designer:
      return strings.DESIGNER_TOOLTIP
    case bookcarsTypes.DressType.Wedding:
      return strings.WEDDING_TOOLTIP
    case bookcarsTypes.DressType.Evening:
      return strings.EVENING_TOOLTIP
    case bookcarsTypes.DressType.Cocktail:
      return strings.COCKTAIL_TOOLTIP
    case bookcarsTypes.DressType.Prom:
      return strings.PROM_TOOLTIP
    default:
      return strings.OTHER_TOOLTIP
  }
}
...
export const getDressSizeTooltip = (size: string) => {
  switch (size) {
    ...
    case bookcarsTypes.DressSize.DoubleExtraLarge:
      return strings.SIZE_XXL_TOOLTIP
    case bookcarsTypes.DressSize.ExtraSmall:
      return strings.SIZE_XS_TOOLTIP
    case bookcarsTypes.DressSize.Custom:
      return strings.SIZE_CUSTOM_TOOLTIP
    default:
      return ''
  }
}
