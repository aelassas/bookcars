...
const SchedulerComponent = forwardRef<SchedulerRef, unknown>((_, ref) => {
  const store = useStore()
  const { view, dialog, loading, loadingComponent, resourceViewMode, resources, translations } = store
