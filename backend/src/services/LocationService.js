...
export const validate = (data) =>
  axios
    .post(`${Env.API_HOST}/api/validate-location`, data, {
...
export const create = (data) =>
  axios
    .post(`${Env.API_HOST}/api/create-location`, data, {
      headers: UserService.authHeader(),
    })
    .then((res) => res.status)
...
export const update = (id, data) =>
  axios
    .put(`${Env.API_HOST}/api/update-location/${id}`, data, {
      headers: UserService.authHeader(),
    })
    .then((res) => res.status)
...
export const check = (id) =>
  axios
    .get(`${Env.API_HOST}/api/check-location/${encodeURIComponent(id)}`, {
      headers: UserService.authHeader(),
    })
    .then((res) => res.status)
