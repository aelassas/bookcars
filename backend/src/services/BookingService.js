...
export const create = (data) =>
  axios
    .post(`${Env.API_HOST}/api/create-booking`, data, {
...
export const update = (data) =>
  axios
    .put(`${Env.API_HOST}/api/update-booking`, data, {
      headers: UserService.authHeader(),
    })
    .then((res) => res.status)
...
export const updateStatus = (data) =>
  axios
    .post(`${Env.API_HOST}/api/update-booking-status`, data, {
      headers: UserService.authHeader(),
    })
    .then((res) => res.status)
...
export const deleteBookings = (ids) =>
  axios
    .post(`${Env.API_HOST}/api/delete-bookings`, ids, {
      headers: UserService.authHeader(),
    })
    .then((res) => res.status)
