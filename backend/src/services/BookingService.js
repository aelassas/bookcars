...
export default class BookingService {
    ...
    static getBookings(companies, statuses, filter, car, page, size) {
        return axios.post(`${Env.API_HOST}/api/bookings/${page}/${size}}`, { companies, statuses, filter, car }, { headers: UserService.authHeader() }).then(res => res.data);
    }
