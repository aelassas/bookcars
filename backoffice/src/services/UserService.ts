 ...
 * @param {string} [appType=bookcarsTypes.AppType.Backoffice]
 * @returns {Promise<number>}
 */
export const resend = (email?: string, reset = false, appType: string = bookcarsTypes.AppType.Backoffice): Promise<number> =>
  axiosInstance
    .post(
