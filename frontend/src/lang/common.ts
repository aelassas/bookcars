...
const strings = new LocalizedStrings({
  fr: {
    ...
    LATITUDE: 'Latitude',
    LONGITUDE: 'Longitude',
    DRAG_MARKER_INSTRUCTIONS: 'Drag the marker to refine the location',
    SEARCH_LOCATION: 'Search for a location...',
    REQUIRED: 'Required',
    MAX_LOCATIONS_REACHED: 'Maximum number of locations reached',
  },
  en: {
    BOOKCARS: env.WEBSITE_NAME,
  ...
  es: {
    ...
    REFINE_LOCATION: 'Refinar ubicación',
    ADDRESS: 'Dirección',
    LATITUDE: 'Latitud',
    LONGITUDE: 'Longitud',
    DRAG_MARKER_INSTRUCTIONS: 'Arrastra el marcador o haz clic en el mapa para establecer la ubicación exacta',
    SEARCH_LOCATION: 'Buscar una ubicación...',
    REQUIRED: 'Obligatorio',
    MAX_LOCATIONS_REACHED: 'Número máximo de ubicaciones alcanzado',
  },
})
