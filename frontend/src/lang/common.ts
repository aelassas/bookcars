...
const strings = new LocalizedStrings({
  ...
  el: {
    GENERIC_ERROR: 'Εμφανίστηκε ένα μη επεξεργασμένο σφάλμα.',
    CHANGE_LANGUAGE_ERROR: 'Εμφανίστηκε σφάλμα κατά την αλλαγή γλώσσας.',
    UPDATED: 'Οι αλλαγές έγιναν με επιτυχία.',
    GO_TO_HOME: 'Μετάβαση στην αρχική σελίδα',
    FULL_NAME: 'Πλήρες όνομα',
    EMAIL: 'Ηλεκτρονικό ταχυδρομείο',
    PASSWORD: 'Κωδικός πρόσβασης',
    EMAIL_ALREADY_REGISTERED: 'Αυτή η διεύθυνση ηλεκτρονικού ταχυδρομείου είναι ήδη καταχωρημένη.',
    CONFIRM_PASSWORD: 'Επιβεβαίωση κωδικού πρόσβασης',
    PHONE: 'Τηλέφωνο',
    LOCATION: 'Τοποθεσία',
    BIO: 'Bio',
    IMAGE_REQUIRED: 'Παρακαλώ προσθέστε μια εικόνα.',
    LOADING: 'Φόρτωση...',
    PLEASE_WAIT: 'Παρακαλώ περιμένετε...',
    SEARCH: 'Αναζήτηση',
    SEARCH_PLACEHOLDER: 'Αναζήτηση...',
    CONFIRM_TITLE: 'Επιβεβαίωση',
    PASSWORD_ERROR: 'Ο κωδικός πρόσβασης πρέπει να αποτελείται από τουλάχιστον 6 χαρακτήρες',
    ...
    CURRENCY: env.CURRENCY,
    DAILY: '/day',
    DELETE_AVATAR_CONFIRM: 'Είστε σίγουρος ότι θέλετε να διαγράψετε την εικόνα;',
    UPLOAD_IMAGE: 'Ανέβασμα εικόνας',
    DELETE_IMAGE: 'Διαγραφή εικόνας',
    UNCHECK_ALL: 'Αποεπιλέξτε όλα',
    CHECK_ALL: 'Έλεγχος όλων',
    CLOSE: 'Κλείσιμο',
    BOOKING_STATUS_VOID: 'Άκυρο',
    BOOKING_STATUS_PENDING: 'Εκκρεμεί',
    BOOKING_STATUS_DEPOSIT: 'Κατάθεση',
    BOOKING_STATUS_PAID: 'Πληρωμένη',
    BOOKING_STATUS_RESERVED: 'Κατοχυρωμένα',
    BOOKING_STATUS_CANCELLED: 'Ακυρωθείσα',
    FROM: 'Από',
    TO: 'Στο',
    OPTIONAL: 'Προαιρετικές παράμετροι',
    AND: 'και',
    RECORD_TYPE_ADMIN: 'Διαχειριστής',
    RECORD_TYPE_SUPPLIER: 'Προμηθευτής',
    RECORD_TYPE_USER: 'Driver',
    TYPE: 'Type',
    CONFIRM: 'Επιβεβαίωση',
    USER: 'Χρήστης',
    INFO: 'Πληροφορίες',
    USER_TYPE_REQUIRED: 'Παρακαλώ συμπληρώστε το πεδίο: Τύπος',
    FIX_ERRORS: 'Παρακαλώ διορθώστε τα σφάλματα.',
    SEND_MESSAGE: 'Αποστολή μηνύματος',
    VERIFIED: 'Επαληθευμένος λογαριασμός',
    CAR: 'Αυτοκίνητο',
    RESEND_ACTIVATION_LINK: 'Επαναποστολή συνδέσμου ενεργοποίησης λογαριασμού',
    ACTIVATION_EMAIL_SENT: 'Αποστολή μηνύματος ηλεκτρονικού ταχυδρομείου ενεργοποίησης',
    EMAIL_NOT_VALID: 'Μη έγκυρη διεύθυνση ηλεκτρονικού ταχυδρομείου',
    PICKUP_LOCATION: 'Τοποθεσία παραλαβής',
    DROP_OFF_LOCATION: 'Τοποθεσία παράδοσης',
    PHONE_NOT_VALID: 'Μη έγκυρος αριθμός τηλεφώνου',
    ALL: 'Όλοι',
    TOS: 'Διάβασα και συμφωνώ με τους όρους χρήσης',
    BIRTH_DATE: 'Ημερομηνία γέννησης',
    RECAPTCHA_ERROR: 'Συμπληρώστε το captcha για να συνεχίσετε',
    TOS_ERROR: 'Παρακαλώ αποδεχτείτε τους όρους χρήσης.',
    BIRTH_DATE_NOT_VALID: `Πρέπει να είστε τουλάχιστον ${env.MINIMUM_AGE} ετών.`,
    BIRTH_DATE_NOT_VALID_PART1: 'Ο οδηγός πρέπει να είναι τουλάχιστον',
    BIRTH_DATE_NOT_VALID_PART2: 'ετών.',
