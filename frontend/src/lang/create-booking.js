...
export const strings = new LocalizedStrings({
    ...
    pl: {
        BOOKING_HEADING: 'Zarezerwuj teraz',
        BOOKING_OPTIONS: 'Twoje opcje rezerwacji',
        BOOKING_DETAILS: 'Twoje dane rezerwacji',
        DAYS: 'Dni',
        CAR: 'Samochód',
        COMPANY: 'Dostawca',
        COST: 'KOSZT',
        DRIVER_DETAILS: 'Szczegóły kierowcy',
        EMAIL_INFO: 'Na ten adres otrzymasz wiadomość e-mail z potwierdzeniem.',
        PHONE_INFO: 'Jeśli musimy pilnie się z Tobą skontaktować.',
        PAYMENT: 'Bezpieczna płatność',
        CARD_NAME: 'Imię i nazwisko',
        CARD_NUMBER: 'Numer karty',
        CARD_MONTH: 'Miesiąc (M)',
        CARD_MONTH_NOT_VALID: 'Nieprawidłowy miesiąc',
        CARD_YEAR: 'Rok (R)',
        CARD_YEAR_NOT_VALID: 'Nieprawidłowy rok',
        CARD_NUMBER_NOT_VALID: 'Nieprawidłowy numer karty',
        CVV: 'CVV',
        CVV_NOT_VALID: 'Nieprawidłowy kod weryfikacyjny karty',
        BOOK: 'Zarezerwuj  teraz',
        SIGN_IN: 'Czy chcesz się zalogować?',
        SECURE_PAYMENT_INFO: 'Twoje dane są chronione przez bezpieczną płatność SSL.',
        CARD_DATE_ERROR: 'Nieprawidłowa data karty',
        SUCCESS: 'Twoja rezerwacja i płatność zostały pomyślnie zrealizowane. Wysłaliśmy Ci wiadomość e-mail z potwierdzeniem.',
        PAY_LATER_SUCCESS: 'Twoja rezerwacja została pomyślnie wykonana. Wysłaliśmy Ci wiadomość e-mail z potwierdzeniem.',
        PAYMENT_OPTIONS: 'Opcje płatności',
        PAY_LATER: 'Zapłać później',
        PAY_LATER_INFO: 'Bezpłatne zmiany i anulowanie',
        PAY_ONLINE: 'Zapłać online',
        PAY_ONLINE_INFO: 'Zmiany i anulowanie na warunkach'
    }
})
