...
const strings = new LocalizedStrings({
  fr: {
    ...
    PAY_DEPOSIT: "Payer l'acompte et confirmer la réservation",
    DEPOSIT: 'Acompte',
  ...
  en: {
    ...
    PAY_DEPOSIT: 'Pay the deposit and confirm the booking',
    DEPOSIT: 'Deposit',
  ...
  es: {
    ...
    PAY_DEPOSIT: 'Pagar el depósito y confirmar la reserva',
    DEPOSIT: 'Depósito',
