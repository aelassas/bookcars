...
const strings = new LocalizedStrings({
  ...
  ar: {
    ...
    PRICE_FOR: 'السعر لكل',
    DAY: 'يوم',
    PICK_UP_CHECKLIST_TITLE: 'ما لا يجب أن تنساه للاستلام',
    PICK_UP_CHECKLIST_ARRIVE_ON_TIME_TITLE: 'كن في الوقت المحدد',
    PICK_UP_CHECKLIST_ARRIVE_ON_TIME_CONTENT: 'شركات التأجير تعطيك المفاتيح فقط في وقت الاستلام المحدد. عادة، سيحتفظون بالسيارة لك لفترة محدودة بعد الوقت المحدد للاستلام. بعد ذلك، من المحتمل أن يؤجروها لعميل آخر.',
    PICK_UP_CHECKLIST_DOCUMENTS_TITLE: 'ما تحتاج إحضاره معك',
    PICK_UP_CHECKLIST_DOCUMENTS_CONTENT: 'عند استلام المركبة، ستحتاج إلى تقديم جواز السفر أو بطاقة الهوية الوطنية وجميع السائقين يجب أن يقدموا رخصة القيادة الخاصة بهم.',
  },
})
