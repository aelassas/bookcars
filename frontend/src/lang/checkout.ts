...
const strings = new LocalizedStrings({
  ...
  ja: {
    BOOKING_HEADING: '今すぐ予約',
    BOOKING_OPTIONS: '予約オプション',
    BOOKING_DETAILS: '予約詳細',
    DAYS: '日数',
    CAR: '車',
    SUPPLIER: 'サプライヤー',
    COST: '費用',
    DRIVER_DETAILS: 'ドライバー詳細',
    EMAIL_INFO: 'このアドレスに確認メールが送信されます。',
    PHONE_INFO: '緊急時に連絡が必要な場合。',
    PAYMENT: '安全な支払い',
    CARD_NUMBER: 'カード番号',
    CARD_NUMBER_NOT_VALID: '無効なカード番号',
    CARD_EXPIRY_NOT_VALID: '無効な有効期限',
    CVV_NOT_VALID: '無効なカード検証コード',
    BOOK: '今すぐ予約',
    SIGN_IN: 'サインインしますか？',
    SECURE_PAYMENT_INFO: 'データはSSL安全な支払いで保護されています。',
    SUCCESS: '支払いが正常に完了しました。確認メールを送信しました。',
    PAY_LATER_SUCCESS: '予約が正常に完了しました。確認メールを送信しました。',
    PAYMENT_OPTIONS: '支払いオプション',
    PAY_LATER: '受取時に支払い',
    PAY_LATER_INFO: '車を受け取る際に全額を支払います。返金可能な保証金が適用される場合があります。',
    PAY_DEPOSIT: 'オンラインで保証金を支払い、予約を確認',
    PAY_DEPOSIT_INFO: 'オンラインで保証金を支払って予約を確認します。残額は受取時に支払います。',
    DEPOSIT: '保証金',
    PAY_ONLINE: '保証金なしで支払い、車を予約',
    PAY_ONLINE_INFO: '前払いなしでオンラインで予約を確認します。全額は受取時に支払います。',
    PAY_IN_FULL: 'オンラインで全額支払い、車を予約',
    PAY_IN_FULL_INFO: '保証金込み。条件付きで変更とキャンセルが可能です。',
    PAYMENT_FAILED: '支払いが失敗しました。',
    CHECKING: '確認中...',
    LICENSE_REQUIRED: '運転免許証が必要です',
    PRICE_FOR: '価格',
    DAY: '日',
    PICK_UP_CHECKLIST_TITLE: '受取時のチェックリスト',
    PICK_UP_CHECKLIST_ARRIVE_ON_TIME_TITLE: '時間通りに到着',
    PICK_UP_CHECKLIST_ARRIVE_ON_TIME_CONTENT: 'レンタル会社は、割り当てられた受取時間にのみキーを渡します。通常、受取予定時刻の後、限られた時間だけ車を保持します。その後、別の顧客に渡される可能性があります。',
    PICK_UP_CHECKLIST_DOCUMENTS_TITLE: '持参するもの',
    PICK_UP_CHECKLIST_DOCUMENTS_CONTENT: '車を受け取る際には、パスポートまたは国民IDカードと運転免許証が必要です。',
  },
})
