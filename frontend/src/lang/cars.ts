...
const strings = new LocalizedStrings({
  fr: {
    ...
    CO2: 'Effet CO2',
    FROM_YOU: 'de vous',
    FROM_SEARCH: 'de votre emplacement de recherche',
    TITLE_1: 'Auto ',
    TITLE_2: ' pour vous',
    ...
    SELECTED_PICK_UP_LOCATION: 'Emplacement de récupération sélectionné',
    CAR_AVAILABILITY: 'Disponibilité du véhicule',
    VEHICLE_SPECIFICATIONS: 'Spécifications du véhicule',
    DISTANCE: 'Distance',
    DISTANCE_KM: 'km de votre emplacement',
  },
  en: {
    NEW_CAR: 'New car',
    ...
    CO2: 'CO2 effect',
    FROM_YOU: 'from you',
    FROM_SEARCH: 'from search location',
    TITLE_1: 'Auto ',
    TITLE_2: ' for you',
    ...
    SELECTED_PICK_UP_LOCATION: 'Selected pick-up location',
    CAR_AVAILABILITY: 'Car availability',
    VEHICLE_SPECIFICATIONS: 'Vehicle specifications',
    DISTANCE: 'Distance',
    DISTANCE_KM: 'km from your location',
  },
  es: {
    NEW_CAR: 'Coche nuevo',
    ...
    CO2: 'Efecto CO2',
    FROM_YOU: 'de ti',
    FROM_SEARCH: 'de ubicación de búsqueda',
    TITLE_1: 'Auto ',
    TITLE_2: 'para ti',
    ...
    SELECTED_PICK_UP_LOCATION: 'Ubicación de recogida seleccionada',
    CAR_AVAILABILITY: 'Disponibilidad del vehículo',
    VEHICLE_SPECIFICATIONS: 'Especificaciones del vehículo',
    DISTANCE: 'Distancia',
    DISTANCE_KM: 'km desde tu ubicación',
  }
})
