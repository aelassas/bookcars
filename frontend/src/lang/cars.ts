...
const strings = new LocalizedStrings({
  fr: {
    ...
    TODDLER_SEAT: 'Siège enfant',
    BOOSTER_SEAT: 'Réhausseur',
    INCLUDED: 'Inclus',
  ...
  es: {
    ...
    INFANT_SEAT: 'Asiento para bebé',
    TODDLER_SEAT: 'Asiento para niño',
  ...
  ja: {
    ...
    FUEL_POLICY_FULL_TO_FULL_TOOLTIP: 'この車は満タンの燃料で提供され、満タンの燃料で返却する必要があります。',
    FUEL_POLICY_FULL_TO_EMPTY_TOOLTIP: 'この車は満タンの燃料で提供され、空のタンクで返却する必要があります。',
    DIESEL_TOOLTIP: 'この車はディーゼルエンジンです',
    GASOLINE_TOOLTIP: 'この車はガソリンエンジンです',
    ELECTRIC_TOOLTIP: 'この車は電気自動車です',
    HYBRID_TOOLTIP: 'この車はハイブリッドです',
    PLUG_IN_HYBRID_TOOLTIP: 'この車はプラグインハイブリッドです',
    GEARBOX_MANUAL_TOOLTIP: 'この車はマニュアルトランスミッションです',
    GEARBOX_AUTOMATIC_TOOLTIP: 'この車はオートマチックトランスミッションです',
    SEATS_TOOLTIP_1: 'この車は',
    SEATS_TOOLTIP_2: '席です',
    DOORS_TOOLTIP_1: 'この車は',
    DOORS_TOOLTIP_2: 'ドアです',
    AIRCON_TOOLTIP: 'この車にはエアコンが装備されています',
    MILEAGE: '走行距離',
    MILEAGE_UNIT: 'KM/日',
    UNLIMITED: '無制限',
    LIMITED: '制限あり',
    CANCELLATION: 'キャンセル',
    CANCELLATION_TOOLTIP: 'レンタル開始日より前に予約をキャンセルできます。',
    AMENDMENTS: '変更',
    AMENDMENTS_TOOLTIP: 'レンタル開始日より前に予約を変更できます。',
    THEFT_PROTECTION: '盗難保護',
    THEFT_PROTECTION_TOOLTIP: 'レンタルには盗難保護が含まれる場合があります。',
    COLLISION_DAMAGE_WAVER: '衝突損害免責',
    COLLISION_DAMAGE_WAVER_TOOLTIP: 'レンタルには衝突損害免責が含まれる場合があります。',
    FULL_INSURANCE: '全額保険',
    FULL_INSURANCE_TOOLTIP: 'レンタルには衝突損害免責と車両の盗難保護が含まれる場合があります。',
    ADDITIONAL_DRIVER: '追加ドライバー',
    INFANT_SEAT: 'ベビーシート',
    TODDLER_SEAT: 'チャイルドシート',
    BOOSTER_SEAT: 'ジュニアシート',
    INCLUDED: '含まれる',
    UNAVAILABLE: '利用不可',
    ...
    EMPTY_LIST: '車がありません。',
    BOOK: 'この車を選択',
    PRICE_DAYS_PART_1: '価格',
    PRICE_DAYS_PART_2: '日',
    PRICE_PER_DAY: '1日あたりの価格：',
    GEARBOX: 'トランスミッション',
    ENGINE: 'エンジン',
    DEPOSIT: '受取時の保証金',
