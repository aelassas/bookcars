...
const Env = {
  ...
  PAGE_SIZE: Number.parseInt(String(process.env.REACT_APP_BC_PAGE_SIZE)) || 30,
  CARS_PAGE_SIZE: Number.parseInt(String(process.env.REACT_APP_BC_CARS_PAGE_SIZE)) || 15,
  BOOKINGS_PAGE_SIZE: Number.parseInt(String(process.env.REACT_APP_BC_BOOKINGS_PAGE_SIZE)) || 20,
  BOOKINGS_MOBILE_PAGE_SIZE: Number.parseInt(String(process.env.REACT_APP_BC_BOOKINGS_MOBILE_PAGE_SIZE)) || 10,
  CDN_USERS: process.env.REACT_APP_BC_CDN_USERS,
  CDN_CARS: process.env.REACT_APP_BC_CDN_CARS,
  PAGE_OFFSET: 200,
  INFINITE_SCROLL_OFFSET: 40,
  COMPANY_IMAGE_WIDTH: Number.parseInt(String(process.env.REACT_APP_BC_COMPANY_IMAGE_WIDTH)) || 60,
  COMPANY_IMAGE_HEIGHT: Number.parseInt(String(process.env.REACT_APP_BC_COMPANY_IMAGE_HEIGHT)) || 30,
  CAR_IMAGE_WIDTH: Number.parseInt(String(process.env.REACT_APP_BC_CAR_IMAGE_WIDTH)) || 300,
  CAR_IMAGE_HEIGHT: Number.parseInt(String(process.env.REACT_APP_BC_CAR_IMAGE_HEIGHT)) || 200,
  ...
  MINIMUM_AGE: Number.parseInt(String(process.env.REACT_APP_BC_MINIMUM_AGE)) || 21,
