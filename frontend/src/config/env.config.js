...
const Env = {
  ...
  BOOKINGS_PAGE_SIZE:
    parseInt(process.env.REACT_APP_BC_BOOKINGS_PAGE_SIZE) || 20,
  BOOKINGS_MOBILE_PAGE_SIZE:
    parseInt(process.env.REACT_APP_BC_BOOKINGS_MOBILE_PAGE_SIZE) || 10,
  CDN_USERS: process.env.REACT_APP_BC_CDN_USERS,
  CDN_CARS: process.env.REACT_APP_BC_CDN_CARS,
  PAGE_OFFSET: 200,
  CAR_PAGE_OFFSET: 400,
  COMPANY_IMAGE_WIDTH:
    parseInt(process.env.REACT_APP_BC_COMAPANY_IMAGE_WIDTH) || 60,
  COMPANY_IMAGE_HEIGHT:
    parseInt(process.env.REACT_APP_BC_COMAPANY_IMAGE_HEIGHT) || 30,
  ...
  RECAPTCHA_ENABLED:
    (process.env.REACT_APP_BC_RECAPTCHA_ENABLED &&
      process.env.REACT_APP_BC_RECAPTCHA_ENABLED.toLowerCase()) === 'true',
  ...
  // Defaults to CLASSIC
  PAGINATION_MODE:
    (process.env.REACT_APP_BC_PAGINATION_MODE &&
      process.env.REACT_APP_BC_PAGINATION_MODE.toUpperCase()) ===
