...
import styles from '../styles/car-filter.module.css';
...
class CarFilter extends Component {
    ...
    render() {
        ...
        return (
            <div className={`${this.props.className ? `${this.props.className} ` : ''}${styles.carFilter}`}>
                <form onSubmit={this.handleSubmit}>
                    <FormControl fullWidth className={styles.pickupLocation}>
                        <LocationSelectList
                    ...
                    {!sameLocation &&
                        <FormControl fullWidth className={styles.dropOffLocation}>
                            <LocationSelectList
                    ...
                    <FormControl fullWidth className={styles.from}>
                        <DateTimePicker
                    ...
                    <FormControl fullWidth className={styles.to}>
                        <DateTimePicker
                    ...
                    <FormControl fullWidth className={styles.chkSameLocation}>
