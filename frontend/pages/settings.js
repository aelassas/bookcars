            ...
            <Master onLoad={this.onLoad} onError={this.onError} strict={true} user={user}>
                {visible && user &&
                    <div className={styles.settings}>
                        <Paper className={`${styles.settingsForm} ${styles.settingsFormWrapper}`} elevation={10}>
                        ...
                        <Paper className={`${styles.settingsNet} ${styles.settingsNetWrapper}`} elevation={10}>
                            <h1 className={styles.settingsFormTitle}> {strings.NETWORK_SETTINGS} </h1>
